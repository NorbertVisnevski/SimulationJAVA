...
public class Wolf extends Carnivore {
    ...
    public Wolf(Map map, AnimalManager animalManager) {
        super(map, animalManager);
    }

    public Wolf(Map map, AnimalManager animalManager, double hunger, double reproductionDrive, double survivalDrive, String sex, double speed, double sensesRange, double mutationRate, Point location) {
        super(map, animalManager, hunger, reproductionDrive, survivalDrive, sex, speed, sensesRange, mutationRate, location);
    }

    @Override
    public Wolf mateWith(Animal other)
    {
        ...
        else
        {
            ...
            Wolf anim =  new Wolf(map, animalManager);
